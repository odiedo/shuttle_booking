    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse"  style="background-color: #001; border-right: 1px solid whitesmoke;"><br>
      <div class="position-sticky">
        <div class="list-group robot-jarvis list-group-flush mt-4">
          ...
          <a href="route.php" class="list-group-item text-warning list-group-item-action py-2 ripple mt-1" style="border-radius: 12px;">
      ...
      <nav id="main-navbar" class="navbar robotica navbar-expand-lg fixed-top" style="background-color: #001; box-shadow: 0 2px 2px 0 paleturquoise;">
        ...
        <div class="container-fluid">
          ...
          <div class="d-none d-md-flex input-group w-auto my-auto">
            <span class="robot-header h3 text-warning"><b><i class="fa fa-map"></i> Load & Release</b></span>
          </div>
          <!-- Right links -->
          ...
          <main style="margin-top: 50px;"><br><br>
            <div class="container pt-1">
              ...
              <div class="row">
                <!-- Begin Page Content -->
                <div class="col-md-7">
                  <iframe src="extra/route.php" style="border: 1px solid grey;"></iframe>
                </div>
                <div class="col-md-5">
                  <h4 class="text-light text-center">Vehicle Release</h4>
                  <iframe src="extra/vehicle_release.php"></iframe>
              </div>
            </div>
          </div>
        <!-- Content Row -->
