    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse"  style="background-color: #001; border-right: 1px solid whitesmoke;"><br>
      <div class="position-sticky">
        <div class="list-group robot-jarvis list-group-flush mt-4">
          ...
          <a href="vehicle.php" class="list-group-item text-warning list-group-item-action py-2 mt-1 ripple mt-1"  style="border-radius: 12px;">
      ...
      <nav id="main-navbar" class="navbar robotica navbar-expand-lg fixed-top" style="background-color: #001; box-shadow: 0 2px 2px 0 paleturquoise;">
        ...
        <div class="container-fluid">
          ...
          <div class="d-none d-md-flex input-group w-auto my-auto">
            <span class="robot-header text-warning h3"><b><i class="fa fa-edit"></i> Registration</b></span>
          </div>
          <!-- Right links -->
                      ...
                      <div class="container-fluid">
                        <div class="">
                          <hr class="bg-dark">
                            <div class="row">
                              <div class="col-md-8">
                                <iframe src="extra/vehicle_driver.php"></iframe>
                              </div>
                              <div class="col-md-4">
                                <iframe src="extra/vehicle.php"></iframe>
                              </div>
                            </div>
                            <hr class="bg-dark">
                            <div class="row">
                              <div class="col-md-6">
                                <h4 class="text-info">Driver List</h4>
                                <table class="table border-0" id="dataTable" width="100%" cellspacing="0">
                                  <thead class="text-info"> 
                                    <tr class="bg-dark"  style="font-size: 11px;">
                                      <th class=""><span class="">Plate</span></th>
                                      <th class=""><span>Trip(s)</span></th>
                                  ...
                                  <tfoot class="text-info bg-dark">
                                    <tr  style="font-size: 11px;">
                                      ...
                                      <th class=""><span>Trip(s)</span></th>
                                      <th class=""><span class="pl-4">Status</span></th>
                                      <th class="">Join Date</th>
                                    </tr>
                                  </tfoot>
                                    <?php   
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                      ...
                                      while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr class="text-light" style="font-size: 11px;">
                                            <td class="pl-4 text-light"><b><span class="text-light"><?php echo $driver_id; ?>. <?php echo $lname; ?> <?php echo $fname; ?></span></b></td>
                                            <td class="pl-4 text-light"><b><?php echo $phone; ?></td>
                                            <td class="pl-4 text-light"><b><?php echo $status; ?></td>
                                            <td class="pl-4 text-light"><b><?php echo $join_date; ?></b></td>
                                        </tr>
                                    <?php                                   }
                                    } else { ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <p class="text-light text-center h3" style="font-family:cursive; font-style: italic;"><i class="fa fa-ticket"></i> No vehicle is registered at he moment!</p>
                                        </div>
                                        <div class="col-md-4">
                              ...
                              <div class="col-md-6">
                                <h4 class="text-warning">Vehicle List</h4>
                                <table class="table border-0" id="dataTable" width="100%" cellspacing="0">
                                      ...
                                      <tfoot class="text-warning bg-dark">
                                          <tr  style="font-size: 11px;">
                                              <th class=""><span>Plate</span></th>
                                              <th class=""><span>Trip(s)</span></th>
                                              <th class=""><span class="pl-4">Status</span></th>
                                ...
                                ?>
                                        <tr class="text-light" style="font-size: 11px;">
                                            <td class="pl-4 text-light"><b><span class="text-light"><?php echo $vehicle_id; ?>. <?php echo $number_plate; ?></span></b></td>
                                            <td class="pl-4 text-light"><b><?php echo $trips; ?></td>
                                            <td class="pl-4 text-light"><b><?php echo $status; ?></td>
                                            <td class="pl-4 text-light"><b><?php echo $join_date; ?></b></td>
                                        </tr>
                                    <?php                                   }
