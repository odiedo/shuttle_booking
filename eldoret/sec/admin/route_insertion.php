    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse"  style="background-color: #001; border-right: 1px solid whitesmoke;"><br>
      <div class="position-sticky">
        <div class="list-group robot-jarvis list-group-flush mt-4">
          ...
          <a href="route_insertion.php" class="list-group-item text-warning list-group-item-action py-2 ripple mt-1" style="border-radius: 12px;">
      ...
      <nav id="main-navbar" class="navbar robotica navbar-expand-lg fixed-top" style="background-color: #001; box-shadow: 0 2px 2px 0 paleturquoise;">
        ...
        <div class="container-fluid">
          ...
          <div class="d-none d-md-flex input-group w-auto my-auto">
            <span class="robot-header text-warning h3"><b><i class="fa fa-map-pin"></i> Route Insertion</b></span>
          </div>
          <!-- Right links -->
    ...
    <!-- Navbar -->
          ...
          <main style="margin-top: 50px;"><br><br>
            <div class="container pt-1">
              ...
              <div class="row">
                <div class="col-md-4">
                  <iframe src="extra/route_insertion.php"></iframe>
                </div>
                <div class="col-md-8">
                  <center><span class="h4 text-center text-light">Routes Available</span></center><br>
                  <iframe src="extra/list_routes.php"></iframe>
                </div>
              </div>
            </div>
          </main>
